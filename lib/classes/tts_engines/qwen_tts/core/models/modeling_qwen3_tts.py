    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        if cache_position is None:
            ...
            cache_position = torch.arange(past_length, past_length + seq_len, device=inputs_embeds.device if inputs_embeds is not None else input_ids.device)
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Generate
            ...
            if torch.isnan(last_id_hidden).any():
                print("[WARNING] last_id_hidden contains NaNs!")
            if past_hidden is not None and torch.isnan(past_hidden).any():
                print("[WARNING] past_hidden contains NaNs!")
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        speech_tokenizer_path = cached_file(
            ...
            force_download=kwargs.pop("force_download", force_download),
            proxies=kwargs.pop("proxies", None),
            resume_download=kwargs.pop("resume_download", None),
            local_files_only=kwargs.pop("local_files_only", local_files_only),
            token=kwargs.pop("use_auth_token", token),
