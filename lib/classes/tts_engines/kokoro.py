...
class Kokoro(TTSUtils, TTSRegistry, name='kokoro'):
    def __init__(self, session:DictProxy):
        try:
            ...
            self.kokoro_lang_code = default_engine_settings[TTS_ENGINES['KOKORO']]['languages'].get(self.language, 'a')
        ...
        try:
            ...
            if self.params.get('inline_voice'):
                ...
                if self.params['current_voice'] is None and error is not None:
                    return False, error
            voice_id = Path(self.params['current_voice']).stem if self.params['current_voice'] else DEFAULT_VOICE
            ...
            for part in sentence_parts:
                ...
                try:
                    ...
                    for _, _, audio_part in generator:
                        ...
                        part_tensor = trim_audio(part_tensor.squeeze(0), self.params['samplerate'], 0.001, 0.006).unsqueeze(0)
