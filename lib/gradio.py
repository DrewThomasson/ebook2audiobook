                ...
                with gr.Tabs(elem_id='gr_tabs') as gr_tabs:
                    with gr.Tab('Dashboard', elem_id='gr_tab_main', elem_classes='gr-tab') as gr_tab_main:
                            ...
                            with gr.Column(elem_id='gr_col_1', elem_classes=['gr-col'], scale=3):
                                ...
                                with gr_group_voice_file:
                                    ...
                                    with gr.Row(elem_id='gr_row_voice_player') as gr_row_voice_player:
                                        gr_voice_player_hidden = gr.Audio(elem_id='gr_voice_player_hidden', type='filepath', interactive=False, waveform_options=gr.WaveformOptions(show_recording_waveform=False), container=False, visible='hidden', show_share_button=True, show_label=False, scale=0, min_width=60)
                        ...
                        with gr.Group(elem_id='gr_group_audiobook_list', elem_classes=['gr-group-no-col'], visible=True) as gr_group_audiobook_list:
                            ...
                            gr_audiobook_player = gr.Audio(elem_id='gr_audiobook_player', label='', type='filepath', autoplay=False, interactive=False, waveform_options=gr.WaveformOptions(show_recording_waveform=False), show_share_button=False, container=True, visible=True)
