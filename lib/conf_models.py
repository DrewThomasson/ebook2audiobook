...
default_engine_settings = {
    ...
    TTS_ENGINES['KOKORO']: {
        ...
        "voices": {
            ...
            "bf_alice": "Alice (UK female)", "bf_lily": "Lily (UK female)",
            "bm_george": "George (UK male)", "bm_fable": "Fable (UK male)",
            "bm_daniel": "Daniel (UK male)", "bm_lewis": "Lewis (UK male)",
            "jf_alpha": "Alpha (Japanese female)", "jf_gongitsune": "Gongitsune (Japanese female)",
            "jf_nezumi": "Nezumi (Japanese female)", "jf_tebukuro": "Tebukuro (Japanese female)",
            "jm_kumo": "Kumo (Japanese male)",
            "zf_xiaobei": "Xiaobei (Chinese female)", "zf_xiaoni": "Xiaoni (Chinese female)",
            "zf_xiaoxiao": "Xiaoxiao (Chinese female)", "zf_xiaoyi": "Xiaoyi (Chinese female)",
            "zm_yunjian": "Yunjian (Chinese male)", "zm_yunxi": "Yunxi (Chinese male)",
            "zm_yunxia": "Yunxia (Chinese male)", "zm_yunyang": "Yunyang (Chinese male)",
            "ef_dora": "Dora (Spanish female)", "em_alex": "Alex (Spanish male)", "em_santa": "Santa (Spanish male)",
            "ff_siwis": "Siwis (French female)",
            "hf_alpha": "Alpha (Hindi female)", "hf_beta": "Beta (Hindi female)",
            "hm_omega": "Omega (Hindi male)", "hm_psi": "Psi (Hindi male)",
            "if_sara": "Sara (Italian female)", "im_nicola": "Nicola (Italian male)",
            "pf_dora": "Dora (Portuguese female)", "pm_alex": "Alex (Portuguese male)", "pm_santa": "Santa (Portuguese male)"
        },
        "rating": {"VRAM": 1, "CPU": 3, "RAM": 2, "Realism": 4}
    },
    TTS_ENGINES['FISH']: {
        "languages": {"zho": "zh", "eng": "en", "jpn": "ja", "kor": "ko", "spa": "es", "por": "pt", "ara": "ar", "rus": "ru", "fra": "fr", "deu": "de", "swe": "sv", "ita": "it", "tur": "tr", "nor": "no", "nld": "nl", "cym": "cy", "eus": "eu", "cat": "ca", "dan": "da", "glg": "gl", "tam": "ta", "hun": "hu", "fin": "fi", "pol": "pl", "est": "et", "hin": "hi", "lat": "la", "urd": "ur", "tha": "th", "vie": "vi", "jav": "jw", "ben": "bn", "yor": "yo", "slv": "sl", "ces": "cs", "swa": "sw", "nno": "nn", "heb": "he", "msa": "ms", "ukr": "uk", "ind": "id", "kaz": "kk", "bul": "bg", "lav": "lv", "mya": "my", "tgl": "tl", "slk": "sk", "nep": "ne", "fas": "fa", "afr": "af", "ell": "el", "bod": "bo", "hrv": "hr", "ron": "ro", "sna": "sn", "mri": "mi", "yid": "yi", "amh": "am", "bel": "be", "khm": "km", "isl": "is", "aze": "az", "snd": "sd", "bre": "br", "sqi": "sq", "pus": "ps", "mon": "mn", "hat": "ht", "mal": "ml", "srp": "sr", "san": "sa", "tel": "te", "kat": "ka", "bos": "bs", "pan": "pa", "lit": "lt", "kan": "kn", "sin": "si", "hye": "hy", "mar": "mr", "asm": "as", "guj": "gu", "fao": "fo"},
        "samplerate": 44100,
        "files": [],
        "voice": default_speaker,
        "voices": {},
