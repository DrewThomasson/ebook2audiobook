...
if "%DOCKER_DESKTOP%"=="1" (
    echo GUI mode:
    echo     docker run %cmd_extra%--rm -it -p 7860:7860 athomasson/%DOCKER_IMG_NAME%
    echo Headless mode:
    echo     docker run %cmd_extra%--rm -it -v "C:\path\to\ebooks:/app/ebooks" -v "C:\path\to\audiobooks:/app/audiobooks" -p 7860:7860 athomasson/%DOCKER_IMG_NAME% --headless --ebook "/app/ebooks/myfile.pdf" [--voice /app/my/voicepath/voice.mp3 etc..]
    echo Docker Compose:
    ...
    echo     wsl --user root -d Ubuntu -- docker run %cmd_extra%--rm -it -p 7860:7860 athomasson/%DOCKER_IMG_NAME%
    echo Headless mode ^(run inside WSL^):
    echo     wsl --user root -d Ubuntu -- docker run %cmd_extra%--rm -it -v "/mnt/c/Users/YourName/ebooks:/app/ebooks" -v "/mnt/c/Users/YourName/audiobooks:/app/audiobooks" -p 7860:7860 athomasson/%DOCKER_IMG_NAME% --headless --ebook "/app/ebooks/myfile.pdf"
