...
COMPONENT:dict[str,Any] = {
    'id': 'e2a-sml',
    'name': 'E2A-SML',
    'description': 'Detect book speakers and generate multi-voice SML.',
    'default_port': 7861,
}
    ...
    try:
        ...
        if module is None:
            ...
            if spec is None or spec.loader is None:
                raise ImportError('Could not load the E2A-SML interface')
...
def create_app(
    *,
    ...
    return build_app(config, theme=theme, css=css)
